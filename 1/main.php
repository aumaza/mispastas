...
<div class="container-fluid">
	...
	<ul class="nav nav-pills nav-stacked" >
          ...
          <form action="main.php" method="POST">
	    <button type="button" class="btn btn-default" name="A"><span class="pull-center "><img src="../icons/actions/user-group-properties.png"  class="img-reponsive img-rounded"> Mis Datos</button><hr>
	    <button type="button" class="btn btn-default" name="B"><span class="pull-center "><img src="../icons/apps/knotes.png"  class="img-reponsive img-rounded"> Mis Pedidos</button><hr>
	    <button type="button" class="btn btn-default" name="C"><span class="pull-center "><img src="../icons/actions/view-catalog.png"  class="img-reponsive img-rounded"> Catálogo</button>
	  </div> 
	  </form>
         </ul>
        </div>
	...
	<nav class="col-xs-12" id="myScrollspy">
	  <div class="panel panel-success" >
	    <div class="panel-heading"><span class="pull-center "><img src="../icons/status/dialog-information.png"  class="img-reponsive img-rounded"> Información</div><br>
